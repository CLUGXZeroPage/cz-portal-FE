  ...
  setup() {
    ...
    const sections = ref([
      ...
      [ // 페이지 2
        ...
        {
          title: "깃, 깃허브 활용 세미나",
          content: "본격적인 개발에 앞서 개발에 필수적인 버전 관리 도구인 Git과 GitHub를 학습하는 세미나입니다. 협업 프로젝트에서 필수적으로 사용되는 만큼, 기본 개념부터 실전 활용법까지 익힐 수 있어요!"
        },
        {
          title: "친구야 만나서 반가워~!",
          content: "학교 주변 핫플레이스 지도를 따라 탐방하는 새내기 교류 시스템입니다. 새로운 환경에서 낯설지 않도록 도와주며, 활동을 통해 새로운 친구들을 사귈 수 있습니다!"
        }
      ],
      [ // 페이지 3
        {
